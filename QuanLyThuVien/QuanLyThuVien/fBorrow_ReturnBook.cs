...
{
    public partial class fBorrow_ReturnBook : Form
    {
        ...
        private void btnAdd_Click(object sender, EventArgs e)
        {
            ...
            if (TicketBookDAO.Instance.InsertTicketBook(idReader, amount))
            {
        ...
        private void dataGridView2_CellContentClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            txtReaderName.Text = dataGridView2.CurrentRow.Cells[4].Value.ToString();
            dateTimePicker1.Value = (DateTime)dataGridView2.CurrentRow.Cells[5].Value;
            dateTimePicker2.Value = (DateTime)dataGridView2.CurrentRow.Cells[6].Value;
            CheckBookID();
        }
        ...
        private void dataGridView3_CellContentClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            txtReaderNameTra.Text = dataGridView3.CurrentRow.Cells[4].Value.ToString();
            dateTimePicker3.Value = (DateTime)dataGridView3.CurrentRow.Cells[5].Value;
            dateTimePicker4.Value = (DateTime)dataGridView3.CurrentRow.Cells[6].Value;
        }
